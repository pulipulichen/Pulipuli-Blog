...
/*
for (let i = 7; 7 < _0x2b54.length; i++) {
  if (_0x2b54[i] === undefined) {
    break
  }
  console.log(['_0x2b54[' + i + ']', _0x2b54[i]])
}
*/
...
rm2 = function (postId, _url, _labels) {
  //let postId = getBloggerPostsVariable('data-post-id')[0]
    ...
    ifrsrc='';
    ifrtb=-1;
    img=postElement['iframe']('img');
    ifr=postElement['iframe']('iframe');
