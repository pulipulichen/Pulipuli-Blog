...
var displayComment = function displayComment() {
  ...
  var bodyFromEntry = function bodyFromEntry(entry) {
  ...
  var parse = function parse(data) {
    ...
    if (data && data.feed && data.feed.entry) {
      for (var i = 0, entry; entry = data.feed.entry[i]; i++) {
        var comment = {}; // comment ID, parsed out of the original id format
...
var addSubCommentReplyLink = function addSubCommentReplyLink() {
  // 為每個回覆的留言後面加上回覆的連結
...
$(function () {
  displayComment();
  addSubCommentReplyLink(); //console.log("aaa")
});
...
(function () {
  ...
  var get_comment_block = function get_comment_block() {
...
var content = __webpack_require__(/*! !../../../../../node_modules/css-loader/dist/cjs.js!../../../../../node_modules/postcss-loader/src!./disqus.css */ "./node_modules/css-loader/dist/cjs.js!./node_modules/postcss-loader/src/index.js!./lib-for-link/src/item-footer/modules/disqus/disqus.css");
...
var content = __webpack_require__(/*! !../../../../../node_modules/css-loader/dist/cjs.js!../../../../../node_modules/postcss-loader/src!./default.css */ "./node_modules/css-loader/dist/cjs.js!./node_modules/postcss-loader/src/index.js!./lib-for-link/src/item-footer/modules/highlight/default.css");
...
var content = __webpack_require__(/*! !../../../../../../node_modules/css-loader/dist/cjs.js!../../../../../../node_modules/postcss-loader/src!./lightbox.css */ "./node_modules/css-loader/dist/cjs.js!./node_modules/postcss-loader/src/index.js!./lib-for-link/src/item-footer/modules/lightbox2-lokeshdhakar/css/lightbox.css");
...
$(function () {
  ...
  $.each($("article a:has(img)"), function (_i) {
    ...
    if ($(this).attr("href").indexOf("amazon.com") === -1) {
      $(this).addClass("lightbox-group").attr("href", $(this).attr("href").replace(/s1600-h/g, "s1600")).attr("data-lightbox", _title);
    }
  });
  /*
   $("head").append($("<link />").attr({
  ...
  $("#lightbox .lb-nav").click(function () {
    var _src = $(this).prev().attr("src"); //console.log(_src);
  ...
  Lightbox.prototype.changeImage = function (imageNumber) {
    ...
    preloader.onload = function () {
      ...
      if (self.options.fitImagesInViewport) {
        ...
        maxImageHeight = windowHeight - self.containerTopPadding - self.containerBottomPadding - 120; // Check if image size is larger then maxWidth|maxHeight in settings
    ...
    this.currentImageIndex = imageNumber; //console.log("顯示了")
    //console.log($image)

    var src = self.album[imageNumber].link;
    $("#lightbox .lb-nav").attr('href', src);
  }; // Stretch overlay to fit the viewport


  Lightbox.prototype.sizeOverlay = function () {
    this.$overlay.width(jQuery(document).width()).height(jQuery(document).height());
...
(function (f, g, k) {
  var l = {
    ...
    next: function next(a) {
      ...
      if (this.currentItem > this.maximumItem + (!0 === this.options.scrollPerPage ? this.options.items - 2 : 0)) if (!0 === this.options.rewindNav) this.currentItem = 0, a = "rewind";else return this.currentItem = this.maximumItem, !1;
...
})(jQuery, window, document); // 後來用printRelatedLabels_thumbs取代，不使用這個
...
var _puli_related_post_render = function _puli_related_post_render(_owl_items) {
...
related_results_labels_thumbs = function related_results_labels_thumbs(e) {
...
removeRelatedDuplicates_thumbs = function removeRelatedDuplicates_thumbs() {
  var e = new Array(0);
  var t = new Array(0);
  var n = new Array(0);
...
contains_thumbs = function contains_thumbs(e, t) {
...
printRelatedLabels_thumbs = function printRelatedLabels_thumbs(e) {
  //console.log(e)
  var t;
  ...
  */
  ...
  var owl = $('.related-posts:first #owl-demo'); //console.log(relatedTitles)
...
maxresults = 10;
splittercolor = ''; //relatedpoststitle = 'Related Posts'

var pulipuli_related_results_labels_thumbs = function pulipuli_related_results_labels_thumbs(e) {
  //console.log(e);
  ...
  for (var t = 0; t < e.feed.entry.length; t++) {
    ...
    try {
      ...
      if (a !== -1 && b !== -1 && c !== -1 && d !== "") {
        ...
        if (typeof defaultnoimage !== "undefined") thumburl[relatedTitlesNum] = defaultnoimage;else thumburl[relatedTitlesNum] = "";
      }
    } //if (relatedTitles[relatedTitlesNum].length > 60) {
    //    relatedTitles[relatedTitlesNum] = relatedTitles[relatedTitlesNum].substring(0, 60) + "...";
    //}
...
var loadLabelsRelatedPosts = function loadLabelsRelatedPosts(callback) {
  var labelList = getBloggerPostsVariable('data-label-name')[0]; //console.log(labelList)
  ...
  var loop = function loop(i) {
    if (i < labelList.length) {
      var label = encodeURIComponent(labelList[i]); //console.log(label)
      ...
      var url = '/feeds/posts/default/-/' + label + '?alt=json-in-script&max-results=' + maxResults + '&callback=?'; //console.log(url)

      lscacheHelper.getJSON(url, function (data) {
        //$.getJSON(url, (data) => {
        //console.log(data)
...
thumburl = new Array();
$(function () {
  var postUrl = getBloggerPostsVariable('data-post-url')[0];

  if (typeof postUrl === 'undefined') {
    return;
  }

  loadLabelsRelatedPosts(function () {
    removeRelatedDuplicates_thumbs(); //console.log('printRelatedLabels_thumbs')
...
var content = __webpack_require__(/*! !../../../../../node_modules/css-loader/dist/cjs.js!../../../../../node_modules/postcss-loader/src!../../../../../node_modules/less-loader/dist/cjs.js!./related-posts.less */ "./node_modules/css-loader/dist/cjs.js!./node_modules/postcss-loader/src/index.js!./node_modules/less-loader/dist/cjs.js!./lib-for-link/src/item-footer/modules/related-posts/related-posts.less");
...
var loadAdminToolsIsLoaded = false;

var loadAdminTools = function loadAdminTools(callback) {
  if (loadAdminToolsIsLoaded === true) {
    if (typeof callback === "function") {
      callback();
    }
  } else {
    var adminToolURL = 'http://pc.pulipuli.info/public/Pulipuli-Blog/lib-for-link/dist/admin-tools.js';
...
/***/ "./node_modules/css-loader/dist/cjs.js!./node_modules/postcss-loader/src/index.js!./lib-for-link/src/item-footer/modules/disqus/disqus.css":
/*!****************************************************************************************************************************************!*\
  !*** ./node_modules/css-loader/dist/cjs.js!./node_modules/postcss-loader/src!./lib-for-link/src/item-footer/modules/disqus/disqus.css ***!
  \****************************************************************************************************************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {
...
// Module
exports.push([module.i, ".post-comment-link{visibility:hidden}", ""]);



/***/ }),

/***/ "./node_modules/css-loader/dist/cjs.js!./node_modules/postcss-loader/src/index.js!./lib-for-link/src/item-footer/modules/highlight/default.css":
/*!********************************************************************************************************************************************!*\
  !*** ./node_modules/css-loader/dist/cjs.js!./node_modules/postcss-loader/src!./lib-for-link/src/item-footer/modules/highlight/default.css ***!
  \********************************************************************************************************************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {
...
/***/ "./node_modules/css-loader/dist/cjs.js!./node_modules/postcss-loader/src/index.js!./lib-for-link/src/item-footer/modules/lightbox2-lokeshdhakar/css/lightbox.css":
/*!**************************************************************************************************************************************************************!*\
  !*** ./node_modules/css-loader/dist/cjs.js!./node_modules/postcss-loader/src!./lib-for-link/src/item-footer/modules/lightbox2-lokeshdhakar/css/lightbox.css ***!
  \**************************************************************************************************************************************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {
...
/***/ "./node_modules/css-loader/dist/cjs.js!./node_modules/postcss-loader/src/index.js!./node_modules/less-loader/dist/cjs.js!./lib-for-link/src/item-footer/modules/related-posts/related-posts.less":
/*!**********************************************************************************************************************************************************************************************!*\
  !*** ./node_modules/css-loader/dist/cjs.js!./node_modules/postcss-loader/src!./node_modules/less-loader/dist/cjs.js!./lib-for-link/src/item-footer/modules/related-posts/related-posts.less ***!
  \**********************************************************************************************************************************************************************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {
...
exports = module.exports = __webpack_require__(/*! ../../../../../node_modules/css-loader/dist/runtime/api.js */ "./node_modules/css-loader/dist/runtime/api.js")(false);
// Module
exports.push([module.i, ".related-posts{overflow:hidden;z-index:100;background:#fff}.related-posts .title{background:none repeat scroll 0 0 #fff;padding:5px 20px;margin:0 0 15px;border-top:1px solid #ddd;border-bottom:1px solid #ddd;font-size:22px}.related-posts #owl-demo{overflow:visible;padding:0 20px;max-height:233px}.related-posts #owl-demo .owl-wrapper-outer{overflow:hidden;max-height:240px;margin-bottom:20px}.related-posts #owl-demo .owl-wrapper-outer .owl-wrapper{position:relative}.related-posts #owl-demo .owl-wrapper-outer .owl-wrapper .owl-item{float:left;padding:0 10px;width:268px!important}.related-posts #owl-demo .owl-wrapper-outer .owl-wrapper .owl-item .item-img{position:relative;max-height:160px;overflow:hidden}.related-posts #owl-demo .owl-wrapper-outer .owl-wrapper .owl-item .item-img .related-post-title{overflow-x:hidden;white-space:nowrap;background-color:rgba(0,0,0,.7);color:#fff;padding-left:10px}.related-posts #owl-demo .owl-wrapper-outer .owl-wrapper .owl-item .item-img img{background:url(//1.bp.blogspot.com/-EpAZ7479vZU/U8q4-6oeF5I/AAAAAAAAB2w/mQFhf-xZRko/s1600/background.png) repeat scroll 0 0 #fff;display:table-cell;text-align:center;font-size:19px;width:100%!important;height:auto!important;margin-top:-35px;position:relative;z-index:-1}.related-posts #owl-demo .owl-wrapper-outer .owl-wrapper .owl-item:first-child{padding:0 10px 0 0}.related-posts .owl-controls.clickable{position:relative;top:-20px}.related-posts .owl-controls.clickable .owl-pagination{position:absolute;right:0;top:-208px}.related-posts .owl-controls.clickable .owl-pagination .owl-page{display:inline-block;width:13px;height:13px;margin:5px 14px 5px -10px;opacity:.5;border-radius:20px;background:none repeat scroll 0 0 #ddd;cursor:pointer}.related-posts .owl-controls.clickable .owl-pagination .owl-page.active,.related-posts .owl-controls.clickable .owl-pagination .owl-page:hover{opacity:1;background:none repeat scroll 0 0 #333}.related-posts.hidden{display:none}", ""]);
