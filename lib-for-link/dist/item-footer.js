...
exports = module.exports = __webpack_require__(/*! ../../../../node_modules/css-loader/dist/runtime/api.js */ "./node_modules/css-loader/dist/runtime/api.js")(true);
// Module
exports.push([module.i, ".entry-content article .table-label{display:block;cursor:pointer;user-select:none;font-size:.5rem;border:1px dotted grey;background-color:grey;color:#fff;clear:both;line-height:.7rem;text-align:center;text-indent:0;border-radius:4px;margin-bottom:.5rem;width:fit-content;padding:.2rem}", "",{"version":3,"sources":["D:/xampp/htdocs/public/Pulipuli-Blog/lib-for-link/src/item-footer/TableUtil/TableUtil.less","TableUtil.less"],"names":[],"mappings":"AAAA,oCAEI,aAAA,CACA,cAAA,CACA,gBAAA,CACA,eAAA,CACA,sBAAA,CACA,qBAAA,CACA,UAAA,CACA,UAAA,CACA,iBAAA,CACA,iBAAA,CACA,aAAA,CAIA,iBAAA,CACA,mBAAA,CACA,iBAAA,CAIA,aCHJ","file":"TableUtil.less","sourcesContent":[".entry-content article {\n  .table-label {\n    display: block;\n    cursor: pointer;\n    user-select: none;\n    font-size: 0.5rem;\n    border: 1px dotted gray;\n    background-color: gray;\n    color: white;\n    clear: both;\n    line-height: 0.7rem;\n    text-align: center;\n    text-indent: 0;\n    //position: absolute;\n    //margin-top: -0.9rem;\n    //margin-left: -0.9rem;\n    border-radius: 4px;\n    margin-bottom: 0.5rem;\n    width: fit-content;\n    padding-left: 0.2rem;\n    padding-right: 0.2rem;\n    padding-top: .2rem;\n    padding-bottom: .2rem;\n  }\n}",".entry-content article .table-label {\n  display: block;\n  cursor: pointer;\n  user-select: none;\n  font-size: 0.5rem;\n  border: 1px dotted gray;\n  background-color: gray;\n  color: white;\n  clear: both;\n  line-height: 0.7rem;\n  text-align: center;\n  text-indent: 0;\n  border-radius: 4px;\n  margin-bottom: 0.5rem;\n  width: fit-content;\n  padding-left: 0.2rem;\n  padding-right: 0.2rem;\n  padding-top: 0.2rem;\n  padding-bottom: 0.2rem;\n}\n"]}]);
