...
exports = module.exports = __webpack_require__(/*! ../../../../node_modules/css-loader/dist/runtime/api.js */ "./node_modules/css-loader/dist/runtime/api.js")(true);
// Module
exports.push([module.i, "#comment-editor{width:100%;height:210px;border-width:0}#comment-editor.hide{display:none}#comments-block img.favicon{height:16px;width:16px;margin-bottom:-2px}#disqus_thread{overflow:hidden;background:#fff;border-bottom:2px solid #ddd;padding:15px 30px 0}#main div.comments#comments{min-height:0}#comment-holder .comment-content img.comment-image{display:block}#comment-holder .comment-content iframe.youtube-embed{max-width:100%;display:block}", "",{"version":3,"sources":["D:/xampp/htdocs/public/Pulipuli-Blog/lib-for-link/src/item-footer/comment/comment.less","comment.less"],"names":[],"mappings":"AAAA,gBACE,UAAA,CACA,YAAA,CACA,cCCF,CDEA,qBACE,YCAF,CDGA,4BACE,WAAA,CACA,UAAA,CACA,kBCDF,CDOA,eACE,eAAA,CACA,eAAA,CACA,4BAAA,CAIA,mBCNF,CDSA,4BACE,YCPF,CDcA,mDACE,aCTF,CDYA,sDACE,cAAA,CACA,aCVF","file":"comment.less","sourcesContent":["#comment-editor {\n  width: 100%;\n  height: 210px;\n  border-width: 0;\n}\n\n#comment-editor.hide {\n  display: none;\n}\n\n#comments-block img.favicon {\n  height: 16px;\n  width: 16px;\n  margin-bottom:-2px;\n}\n\n\n/* ************************ */\n\n#disqus_thread {\n  overflow: hidden;\n  background: #FFFFFF;\n  border-bottom: 2px solid #DDDDDD;\n  //padding: 25px;\n  \n  padding: 15px 30px;\n  padding-bottom: 0;\n}\n\n#main div.comments#comments {\n  min-height: initial;\n}\n\n\n/*****************************/\n/* 20181021 留言裡面的圖片 */\n/* https://blog.pulipuli.info/2017/10/k-determin-optimal-number-of-clusters.html */\n#comment-holder .comment-content img.comment-image {\n  display: block;\n}\n\n#comment-holder .comment-content iframe.youtube-embed {\n  max-width: 100%;\n  display: block;\n}\n","#comment-editor {\n  width: 100%;\n  height: 210px;\n  border-width: 0;\n}\n#comment-editor.hide {\n  display: none;\n}\n#comments-block img.favicon {\n  height: 16px;\n  width: 16px;\n  margin-bottom: -2px;\n}\n/* ************************ */\n#disqus_thread {\n  overflow: hidden;\n  background: #FFFFFF;\n  border-bottom: 2px solid #DDDDDD;\n  padding: 15px 30px;\n  padding-bottom: 0;\n}\n#main div.comments#comments {\n  min-height: initial;\n}\n/*****************************/\n/* 20181021 留言裡面的圖片 */\n/* https://blog.pulipuli.info/2017/10/k-determin-optimal-number-of-clusters.html */\n#comment-holder .comment-content img.comment-image {\n  display: block;\n}\n#comment-holder .comment-content iframe.youtube-embed {\n  max-width: 100%;\n  display: block;\n}\n"]}]);
